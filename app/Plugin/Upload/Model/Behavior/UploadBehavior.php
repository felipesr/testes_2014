...
class UploadBehavior extends ModelBehavior {
	...
	public $defaults = array(
		...
		'pathMethod' => 'flat', // Does not create a path for each record. Files are moved to the value of the 'path' option. (abaixo)
		'path' => '{ROOT}webroot{DS}files{DS}{model}{DS}{field}{DS}', // equivale a webroot/files/<model>/field/
		//'path' => '{ROOT}webroot{DS}img', // equivale a webroot/img
